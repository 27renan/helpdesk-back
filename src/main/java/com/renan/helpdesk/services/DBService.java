...
import com.renan.helpdesk.domain.enums.Perfil;
import com.renan.helpdesk.domain.enums.Prioridade;
import com.renan.helpdesk.domain.enums.Status;
import com.renan.helpdesk.repositories.ChamadoRepository;
import com.renan.helpdesk.repositories.PessoaRepository;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Renan Oliveira", "550.482.150-95", "renan@mail.com", encoder.encode("123"));
